...
class ASLWindow(QMainWindow):
    def __init__(self):
        ...
        self.detector = HandDetector(
            staticMode=False, maxHands=1, detectionCon=0.6, minTrackCon=0.5
        )
    ...
    def on_capture(self):
        ...
        pix_roi = QPixmap.fromImage(qt_roi).scaled(
            self.roi_label.width(), self.roi_label.height(), Qt.KeepAspectRatio
        )
    ...
    def on_erase(self):
        ...
        self.sentence_label.setText(
            self.sentence or "Your sentence will appear here..."
        )
